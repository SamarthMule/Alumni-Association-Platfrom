...
const allJobsData = [
  {
    ...
    description: "Good communication skills (must) Experience of complex crawling like captcha, recaptcha and bypassing proxy, etc. Experience with web crawler projects is a plus. Experience in productionizing machine learning models"
  },
  {
    company: "Facebook",
    ...
    description: "Experience with React and JavaScript. Strong problem-solving skills. Ability to work in a fast-paced environment. Experience with version control systems like Git."
  },
  {
    company: "Amazon",
    ...
    description: "Proficiency in Python and SQL. Experience with data analysis and machine learning. Strong analytical skills. Ability to work with large datasets."
  }
];
          ...
          <Box>
            <Card.Body>
              <Card.Title mb="2">
                ...
                <HStack mt="4">
                  <Text color="purple.800" fontWeight="bold">Skills:</Text>
            ...
            <Card.Footer>
              ...
              >
                ...
                <DialogContent>
                  <DialogCloseTrigger color="orange.600" bg="purple.100" p="2" m="2">Cancel</DialogCloseTrigger>
                  <DialogBody>
                    <Card.Body>
                      <Card.Title mb="2" p="2">
