...
export const connectToSocketIO = (server) => {
    const io = new Server(server, {
        cors: {
            origin: ["http://localhost:5173", "http://localhost:8000","https://lpdjx99c-8000.inc1.devtunnels.ms/","https://lpdjx99c-5173.inc1.devtunnels.ms/"],
            methods: ["GET", "POST", "PUT", "DELETE"],
            transports: ['websocket', 'polling'], // Ensure WebSocket is the preferred transport
        },
    });
